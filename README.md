...
##### **2. FIXING the page to be displaying correctly : DONE✅**



* improve \& clean div structure **✅**
* fix layout (Flexbox), preventing page to get crushed if resize :

 	**- removed height on section, was causing major size problems for the entire page ✅**
...
--> now the page is responsive : it will "resize" correctly if the page skrink or else ; it wraps content accordingly to max-width and fits for larger or smaller screen size !

--> global layout is centered





##### **3. ADDING more creative elements according to the theme : working on ..**
